...
class MyForm(QWidget):
    def __init__(self, table, parent=None):
        ...
        self.setWindowTitle('NoteBook-2.0')
        self.table = table
        ...
        self.phone.setPlaceholderText('88005553535')
...
class MainApp(QWidget):
    def __init__(self, parent=None):
        ...
        if len(happy_string) > 0:
            title = "Don't forget to congratulate:\n"
            QMessageBox.information(self, 'Birthday reminder', title + happy_string)
